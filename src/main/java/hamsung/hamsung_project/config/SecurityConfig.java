...
import hamsung.hamsung_project.config.jwt.CustomLogoutFilter;
import hamsung.hamsung_project.config.jwt.JWTFilter;
import hamsung.hamsung_project.config.jwt.JWTUtil;
import hamsung.hamsung_project.config.jwt.LoginFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                .cors(corsCustomizer -> corsCustomizer.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://localhost:3000", "https://nozigak.site"));
        ...
        http
                .authorizeHttpRequests((auth) -> auth
                        .requestMatchers("/login", "/", "/users", "/health-check", "/recruits").permitAll()
